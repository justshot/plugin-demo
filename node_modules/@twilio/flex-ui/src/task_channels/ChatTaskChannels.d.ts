...
export declare function createChatTaskChannel(name: string, isApplicable: TaskChannelApplicableCb, icon?: string | React.ReactNode, iconActive?: string | React.ReactNode, color?: string, reservedTemplate?: string, charLimit?: number): TaskChannelDefinition;
