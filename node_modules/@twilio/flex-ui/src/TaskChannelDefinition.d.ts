...
import { ContentFragmentProps, RemoveComponentCallOptions } from "@twilio/frame-ui";
 ...
 *
 * @typedef {"Info" | "Call" | "Chat" | "Video" | "Wrapup"} TaskChannelCapability
 ...
 * @property {T} [Accepted] value for accepted state
 * @property {T} [Wrapping] value for wrapping state
 * @property {T} [Completed] value for completed state
 * @property {T} [Canceled] value for canceled state
 * @property {T} [Pending] value for pending state
 * @memberof TaskChannelDefinition
 */
...
export interface TaskChannelDefinition {
    ...
    templates?: {
        ...
        CallCanvas?: {
            ...
            firstLine?: TaskStatusBasedType<string>;
            secondLine?: TaskStatusBasedType<string>;
            footerLine?: TaskStatusBasedType<string>;
        };
        TaskListItem?: {
            firstLine?: TaskStatusBasedType<string>;
            secondLine?: TaskStatusBasedType<string>;
