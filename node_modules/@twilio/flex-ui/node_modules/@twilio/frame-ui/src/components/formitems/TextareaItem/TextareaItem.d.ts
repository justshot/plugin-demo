 ...
 * @typedef TextareaItemProps
 * @property {TextareaField} field - The textarea field component
 * @extends {ItemProps}
 */
 ...
 *
 * @typedef TextareaFieldAttributes
...
/**
 * @classdesc Textarea form item
 * @class TextareaField
 * @param {TextareaItemProps} props - props
 * @extends {React.PureComponent}
 */
export declare class TextareaItem extends React.PureComponent<TextareaItemProps, undefined> {
    render(): JSX.Element;
}
