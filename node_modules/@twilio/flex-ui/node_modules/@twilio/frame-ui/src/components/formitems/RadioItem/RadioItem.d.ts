 ...
 * @typedef RadioItemProps
 * @property {RadioField} field - The radio field component
 ...
 * @property {RadioFieldAttributes} [attributes] - Custom attributes for the radio field
 */
...
/**
 * @classdesc Radio form item
 * @param {RadioItemProps} props - props
 * @extends {React.PureComponent}
 */
export declare class RadioItem extends React.PureComponent<RadioItemProps, undefined> {
    render(): JSX.Element;
}
