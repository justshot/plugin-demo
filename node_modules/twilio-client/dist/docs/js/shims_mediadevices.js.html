...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: shims/mediadevices.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: shims/mediadevices.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const EventTarget = require('./eventtarget');
